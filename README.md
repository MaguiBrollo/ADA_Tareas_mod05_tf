...
Esta opción del menú principal, permite intercambiar entre el `Modo Claro` con tonalidades de color púrpura, y el `Modo Oscuro` que presneta la aplicación en tonos ge grises.
